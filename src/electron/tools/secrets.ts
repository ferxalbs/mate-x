...
const SECRET_PATTERNS = [
  ...
  { name: 'Generic API Key', regex: /"?[a-zA-Z0-9_-]*[aA][pP][iI]_[kK][eE][yY]"?[ :]+['"]([a-zA-Z0-9_-]{16,})['"]/g },
  { name: 'Generic Secret', regex: /"?[a-zA-Z0-9_-]*[sS][eE][cC][rR][eE][tT]"?[ :]+['"]([a-zA-Z0-9_-]{16,})['"]/g },
...
export const secretScanTool: Tool = {
  name: 'secret_scan',
  description: 'Deep-scans the repository for hardcoded secrets, API keys, and tokens.',
  parameters: {
    type: 'object',
    properties: {
      path: {
