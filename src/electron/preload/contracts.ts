export const IPC = {
  ...
  EVIDENCE_LIST: 'evidence:list-packs',
  EVIDENCE_GET: 'evidence:get-pack',
  EVIDENCE_VERIFY: 'evidence:verify-attestation',
  EVIDENCE_EXPORT_ZIP: 'evidence:export-compliance-zip',
