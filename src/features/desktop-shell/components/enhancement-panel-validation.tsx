...
export function ValidationSection({
  ...
  return (
    <section className="space-y-3">
      ...
      <div className="rounded-2xl border border-border/40 bg-mate-control-bg text-card-foreground font-mono text-[12px] shadow-none p-3.5">
        <div className="mb-3 flex items-center gap-1.5 border-b border-border/40 pb-2 text-muted-foreground">
