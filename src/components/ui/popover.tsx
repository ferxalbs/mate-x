    ...
    <PopoverPrimitive.Portal>
      ...
      >
        <PopoverPrimitive.Popup
          className={cn(
            "relative flex h-(--popup-height,auto) w-(--popup-width,auto) origin-(--transform-origin) rounded-2xl border border-border/40 bg-popover/80 backdrop-blur-3xl text-popover-foreground shadow-none outline-none transition-[width,height,scale,opacity] has-data-[slot=calendar]:rounded-2xl data-starting-style:scale-98 data-starting-style:opacity-0",
            tooltipStyle &&
