...
function Card({ className, render, ...props }: useRender.ComponentProps<"div">) {
  const defaultProps = {
    className: cn(
      "relative flex flex-col rounded-2xl border border-border/40 bg-card text-card-foreground shadow-none",
      className,
    ),
    "data-slot": "card",
  };
...
function CardFrame({ className, render, ...props }: useRender.ComponentProps<"div">) {
  const defaultProps = {
    className: cn(
      "[--clip-top:-1rem] [--clip-bottom:-1rem] *:data-[slot=card]:first:[--clip-top:1px] *:data-[slot=card]:last:[--clip-bottom:1px] flex flex-col relative rounded-2xl border border-border/40 bg-card text-card-foreground shadow-none *:data-[slot=card]:-m-px *:not-last:data-[slot=card]:rounded-b-xl *:not-first:data-[slot=card]:rounded-t-xl *:data-[slot=card]:[clip-path:inset(var(--clip-top)_1px_var(--clip-bottom)_1px_round_calc(var(--radius-2xl)-1px))] *:data-[slot=card]:shadow-none *:data-[slot=card]:bg-clip-padding",
      className,
    ),
